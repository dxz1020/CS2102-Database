<?php
  ...
  $query = "SELECT I.item_id, I.title, I.category, I.genre, I.device, I.release_date, I.price, I.rent_price, CASE WHEN L.likes IS NULL THEN 0 ELSE L.likes END AS likes FROM Item LEFT JOIN (SELECT item, COUNT(*) AS likes FROM Likes GROUP BY item) L ON L.item=I.item_id"
